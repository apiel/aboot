...
#define ABOOT_RTC_MAGIC 0x2334ae68
#define ABOOT_RTC_READ 1
#define ABOOT_RTC_WRITE 0
#define ABOOT_RTC_ADDR 64
...
*/
typedef struct {
	uint32 magic;           ///< Magic, identifies rBoot RTC data - should be ABOOT_RTC_MAGIC
...
static uint8 default_config(aboot_config *romconf, uint32 flashsize) {
	romconf->count = 2;
